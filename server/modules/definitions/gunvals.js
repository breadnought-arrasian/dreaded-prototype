module.exports = {
    ...
    // Bases
    basic: { reload: 18 / 1.5, recoil: 1.4 * 2, shudder: 0.1, damage: 0.75, speed: 4.5, spray: 15 },
    drone: { reload: 50 / 1.5, recoil: 0.25 * 2, shudder: 0.1, size: 0.6, speed: 2, spray: 0.1 },
    trap: { reload: 36 / 1.5, shudder: 0.25, size: 0.6, damage: 0.75, speed: 5 * 1.2, spray: 15, resist: 3 },
    swarm: { reload: 18, recoil: 0.25 * 2, shudder: 0.05, size: 0.4, damage: 0.75, speed: 4, spray: 5 },
    factory: { reload: 60 / 1.5, shudder: 0.1, size: 0.7, damage: 0.75, speed: 3, spray: 0.1 },
    indus: { reload: 45 / 1.5, shudder: 0.1, size: 0.7, damage: 0.75, speed: 3, spray: 0.1 }, 
    productionist: { reload: 75 / 1.5, recoil: 0.25 * 2, shudder: 0.05, size: 0.6, damage: 0.75, speed: 4, range: 1.5, spray: 5 },
    barricade: { reload: 24 / 1.5, recoil: 1 * 2, shudder: 0.1, size: 0.6, health: 0.5, damage: 0.5, pen: 0.75, speed: 6.5 * 1.2, maxSpeed: 1, density: 1, spray: 15, resist: 3 },
    bossminion: { reload: 60, shudder: 0.1, speed: 3, spray: 0.1 },

    // Spammers
    single: { reload: 1.05, speed: 1.05 },
    twin: { recoil: 0.5, shudder: 0.9, health: 0.9, damage: 0.7, spray: 1.2 },
    double: { damage: 0.9 },
    hewn: { reload: 1.25, recoil: 1.5, health: 0.9, damage: 1, maxSpeed: 0.9 },
    ...
    assass: { reload: 1.65, shudder: 0.25, health: 1.15, pen: 1.1, speed: 1.2, maxSpeed: 1.2, density: 3, resist: 1.3 },
    hunter: { reload: 1.5, recoil: 0.7, size: 0.95, damage: 0.9, speed: 1.1, maxSpeed: 0.8, density: 1.2, resist: 1.15 },
    hunter2: { size: 0.9, health: 1, damage: 0.9, pen: 0.9, density: 1.2, resist: 1.1 },
    ...
    rifle: { reload: 0.8, recoil: 0.8, shudder: 1.5, health: 0.8, damage: 0.8, pen: 0.9, speed: 1.15, maxSpeed: 1.15, spray: 2 },
    blunderbuss: { recoil: 0.1, shudder: 0.5, health: 0.4, damage: 0.2, pen: 0.4, spray: 0.5 },
    coil: [1, 1.15, 1, 1, 1, 1.1, 1, 1.175, 1.17, 1, 1.1, 1, 1],
    yottacoil: [1.5, 1, 1, 1, 1.5, 1.65, 2, 2, 2, 1, 1, 1, 1],
    knocker: { reload: 1.15, damage: 0.5, pen: 1.2, speed: 1.1, maxSpeed: 1.1, density: 20, resist: 20 },
    hitman: { damage: 0.6, pen: 0.8, maxSpeed: 0.75 },
    ...
    mach2:{ reload: 0.5, recoil: 0.8, shudder: 1.2, health: 0.7, damage: 0.7, maxSpeed: 0.8, spray: 1.3 },
    ...
    nail: { reload: 0.85, recoil: 2.5, size: 0.8, damage: 0.7, maxSpeed: 2, density: 2 },
    ...
    chain: { reload: 1.25, recoil: 1.33, shudder: 0.8, health: 0.8, pen: 1.1, speed: 1.35, maxSpeed: 1.35, range: 1.1, density: 1.25, spray: 0.5, resist: 1.1 },
    atomizer: { reload: 0.3, recoil: 0.8, size: 0.5, damage: 0.9, speed: 1.2, maxSpeed: 0.8, spray: 2.25 },
    ...
    vulcan: [2, 0.1, 0.05, 0.8, 0.8, 1.7, 1.5, 0.9, 3, 1, 0.6, 0.1, 1],
    flame: { reload: 2, shudder: 2, health: 2, speed: 1.5, maxSpeed: 0.5, range: 1.5, density: 2, spray: 1.25, },
    mecha: { reload: 1.925 / 2, recoil: 0.01, shudder: 0.01, size: 1, health: 0.625, damage: 0.294, pen: 0.845, speed: 1.35, maxSpeed: 1.1, range: 1, density: 1, spray: 1.4, resist: 1 },
    ...
    minion: { recoil: 0.25, shudder: 2, health: 0.4, damage: 0.6, pen: 1.2, range: 0.75, spray: 2 },
    ...
    skim: { recoil: 0.7, shudder: 0.8, size: 0.9, health: 1.35, damage: 0.8, pen: 2, speed: 0.3, maxSpeed: 0.3, resist: 1.1 },
    ...
    rocketeerMissileTrail: { reload: 0.5, recoil: 5, shudder: 1.5, size: 0.8, health: 0.8, damage: 0.7, speed: 0.9, maxSpeed: 0.8, spray: 5 },

    // Traps and blocks
    block: { reload: 1.1, recoil: 2, shudder: 0.1, size: 1.5, health: 1.5, damage: 0.9, pen: 1.25, speed: 1.5, maxSpeed: 2.5 * 0.8, range: 1.25, resist: 1.25 },
    ...
    trapperDominator: { reload: 1.26, recoil: 0, shudder: 0.25, health: 1.25, damage: 1.45, pen: 1.6, speed: 0.25, maxSpeed: 2, range: 0.7, spray: 0.5 },
    mayhemtrap: { reload: 0.1, shudder: 20, pen: 0.000001, speed: 2, range: 0.5, spray: 3 },
    ...
    // Reload
    halfreload: { reload: 2 },
    half_reload: { reload: 2 },
    lessreload: { reload: 1.5 },
    less_reload: { reload: 1.5 },
    ...
    bitmorepower: { health: 1.1, damage: 1.1, pen: 1.1, resist: 1.1 },
    bitlesspower: { health: 0.9, damage: 0.9, pen: 0.9, resist: 0.9 },
    ion: { reload: 0.12, recoil: 0.0001, shudder: 5, size: 0.0001, health: 30, damage: 0.000001, pen: 10, speed: 5, range: 0.1, density: 0.0001 },
}
